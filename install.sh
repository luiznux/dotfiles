...
install_packages(){
    ...
    image=" eog feh tumbler gthumb ffmpegthumbnailer mplayer gst-libav imagemagick sxiv gimp scrot deepin-screenshot w3m ueberzug gnome-video-effects cheese pdf2svg "
