...
install_packages(){
    ...
    image=" eog feh tumbler gthumb ffmpegthumbnailer webp-pixbuf-loader mplayer gst-libav imagemagick sxiv gimp inkscape scrot flameshot w3m ueberzug gnome-video-effects cheese pdf2svg "
